...
const topics = [
  ...
  "graphs", "1d_dynamic_programming", "intervals", "greedy", "advanced_graphs",
  "2d_dynamic_programming", "bit_manipulation", "math_and_geometry"
];

export function EditPreferences({ initialPreferences, userId }) {
